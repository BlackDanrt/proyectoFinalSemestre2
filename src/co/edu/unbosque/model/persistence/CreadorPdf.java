...
public class CreadorPdf {
	...
	public static void crearPDF() {
		...
		try {
			...
			contenido.showText("Fecha de generación: " + fecha + "");
			contenido.endText();
			...
			contenido.showText("Hora de generación: " + hora + "");
			contenido.endText();
			...
			contenido.showText("Gráficas de Media de likes y Edad");
			contenido.endText();
			...
			contenido2.newLine();
			contenido2.newLineAtOffset(50, pagina.getMediaBox().getHeight() - 140);
			contenido2.showText("Gráficas de Moda de likes y Edad");
			contenido2.endText();
			...
			contenido3.newLine();
			contenido3.newLineAtOffset(50, pagina.getMediaBox().getHeight() - 140);
			contenido3.showText("Gráficas de Moda de likes y Edad");
			contenido3.endText();
